 ...
 */
{
    ...
    let box__title_inner=document.querySelector(".box__title-inner")
    ...
    class Overlay {
        ...
        show(contentItem) {
            ...
            TweenMax.to(this.DOM.reveal, .5, {
                ...
                onComplete: () => {
                  ...
                  testDiv.classList.add("preview-open")
                    // show preview
                    ...
                    box__title_inner.style.opacity=0;
        ...
        hide() {
            ...
            box__title_inner.style.opacity=1;
            // show revealer
            TweenMax.to(this.DOM.reveal, .5, {
                //delay: 0.15,
                ease: 'Power3.easeOut',
                ...
                onComplete: () => {
                   ...
                   testDiv.classList.remove('preview-open')
                    // hide preview
